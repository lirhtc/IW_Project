...
Server_Party.prototype.stringify = function() {
    return JSON.stringify(this)
};

Server_Party.prototype.parse = function(jsonData) {
    Object.assign(this,JSON.parse(jsonData));
};

Server_Party.prototype.onBattleStart = function() {
